    ...
    return (
        <div className="w-full mt-[10%] flex flex-col justify-center items-center">
            <div className="flex flex-col justify-center items-center">
                <h2 className="typewriter text-lg md:text-6xl py-3 font-bold text-cyan-950 dark:text-slate-100 px-1 md:mb-3">
            ...
            <div className="w-full p-6 text-3xl md:text-6xl font-bold text-cyan-950 dark:text-slate-100 text-center">
                <h2>
                    <span> {days}</span> :
                    <span> {hours}</span> :
                    <span> {minutes}</span> :
